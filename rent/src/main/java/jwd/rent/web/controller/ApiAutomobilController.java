...
public class ApiAutomobilController {
	...
	@RequestMapping(method=RequestMethod.POST, value="/{id}/vracanje")
	public ResponseEntity<NajamDTO> returnACar(@PathVariable Long id){
		
		Najam n = najamService.returnACar(id);
